Public NotInheritable Class classBdd
    Shared _provider As String = "Microsoft.SQLSERVER.CE.OLEDB.3.5"
    ...
    Shared Function LoadDb(ByVal Sql As String, ByVal Table As String, ByVal Base As String) As DataTable
        ...
        cnx.ConnectionString = "Provider = " & _provider & "; Data Source = " & _basePath 'définition du chemin de connexion
    ...
    Shared Function LoadDataSelected(ByVal Sql As String, ByVal Base As String, ByVal Champs As String) As String
        Dim cnx As New OleDb.OleDbConnection() 'On crée la variable de connexion
